...
Hematocrit response towards OAH & successful parturition conditions vs ambient & atresia: Individuals exposed to OAH treatment and have a successful pregnancy are hypothesized to have higher hematocrit levels compared to atresia patients in the ambient treatment tank.
...
Sodium response to OAH stress compared to ambient treatment: I suspect internal blood sodium concentrations to increase in response to OAH stress. This is suspected due to the previous studies on acid secretion associated with NA+ absorption (Evans et al. 2005).
...
Chloride response to OAH stress compared to ambient treatment: If NA+/Cl- transport are uncoupled due to low pH (as a longer term, acclimataory response) then chloride concentrations may not change (or be directly associated with suspected changes in sodium concentrations).

Chloride response to atresia compared to successful parturition: It is unknown how pregnancy will effect internal chloride ion concentrations. 

Chloride response towards OAH & atresia conditions vs ambient & successful parturition: It is unknown how the interactive effects of OAH treatment and parturition would alter internal chloride ion concentrations. 
