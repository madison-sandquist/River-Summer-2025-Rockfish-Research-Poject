---
title: "SU25_River_Rockfish_Proj_V0.5"
...
# ggplot(data = Secondary_Samples, aes(x = Pregnant.Or.Atresia, y = pH, fill = Ambient.Or.OAH)) +
#   geom_boxplot() +
#   geom_jitter(position = position_jitterdodge(jitter.width = 0.3), alpha = 0.5)
#   geom_jitter(aes(color = Ambient.Or.OAH))


# pH boxplot
pH_boxplot <- ggplot(data = Secondary_Samples, aes(x = Pregnant.Or.Atresia, y = pH, fill = Ambient.Or.OAH)) +
  geom_boxplot(aes(x = Pregnant.Or.Atresia, y = pH, fill = Ambient.Or.OAH)) +
...
ggsave(filename = "data-images/pH_parturition_boxplot.pdf", plot = pH_parturition_boxplot, device = "pdf")
ggsave(filename = "data-images/pH_parturition_boxplot.png", plot = pH_parturition_boxplot, device = "png")
...
Secondary_Samples %>%
  ...
  stat_function(fun = dnorm, args = c(mean = mean(Secondary_Samples$pH), sd = sd(Secondary_Samples$pH)), col = "green") +
...
lm(pH ~ Pregnant.Or.Atresia * Ambient.Or.OAH, data = Secondary_Samples) %>% plot()
...
Summary results of residual scedasticity (equal variance of residuals):
